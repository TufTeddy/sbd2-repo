...
bool TPNumberEditor::isZero() {
    return TPNumber(number, std::to_string(base), "7").getNumber() == 0.0;
}
...
unsigned int TPNumberEditor::getBase() const
{
    return base;
}

void TPNumberEditor::setBase(unsigned int value)
{
    base = value;
}

int TPNumberEditor::getPrecision() const
{
    return precision;
}

void TPNumberEditor::setPrecision(int value)
{
    precision = value;
}
